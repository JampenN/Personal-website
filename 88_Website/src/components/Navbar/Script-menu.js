...
export function initNav() {
  ...
  const shouldClose = sessionStorage.getItem("closeMenuOnLoad");
  if (shouldClose) {
    sessionStorage.removeItem("closeMenuOnLoad");
    closeMenu();
  }
// });
    ...
    const preloadImages = ["/images/img-1.jpg", "/images/img-2.jpg", "/images/img-3.jpg", "/images/img-4.jpg"];
